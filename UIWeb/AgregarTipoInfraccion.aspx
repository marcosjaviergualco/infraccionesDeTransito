...
<body>
    <form id="form1" runat="server">
        ...
        <asp:RadioButton ID="RadioButtonGrave" runat="server" style="z-index: 1; left: 305px; top: 54px; position: absolute" Text="Grave" />
        <asp:RadioButton ID="RadioButtonLeve" runat="server" style="z-index: 1; left: 305px; top: 74px; position: absolute" Text="Leve" />
