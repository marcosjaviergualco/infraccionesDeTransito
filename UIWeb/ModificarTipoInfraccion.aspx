...
<body>
    <form id="form1" runat="server">
        ...
        <asp:RadioButton ID="RadioButtonGrave" runat="server" GroupName="categoria" style="z-index: 1; left: 303px; top: 65px; position: absolute" Text="Grave" AutoPostBack="True" />
